...
var permissionCatalog = []PermissionDefinition{
	...
	{Key: PermissionPerformanceFeedbackView, Scope: ScopeTenant, Description: "Visualizar feedbacks de desempenho."},
	{Key: PermissionPerformanceFeedbackEdit, Scope: ScopeTenant, Description: "Conduzir feedbacks de desempenho."},
	...
	{Key: PermissionTranscriptionsView, Scope: ScopeTenant, Description: "Visualizar audios e transcricoes dos atendimentos."},
	{Key: PermissionTranscriptionsEdit, Scope: ScopeTenant, Description: "Solicitar transcricoes, analises e editar sua configuracao."},
	...
	{Key: PermissionPlanningView, Scope: ScopeTenant, Description: "Visualizar escalas, jornadas e metas do Planejamento."},
	{Key: PermissionPlanningEdit, Scope: ScopeTenant, Description: "Editar configuracoes e escalas do Planejamento."},
	...
	{Key: PermissionManageView, Scope: ScopeTenant, Description: "Visualizar as rotas agrupadas em Manage."},
	...
	{Key: PermissionThemesView, Scope: ScopeTenant, Description: "Visualizar a workspace Temas."},
...
var defaultRolePermissionMap = map[auth.Role][]string{
	auth.RoleConsultant: {
		...
		PermissionPerformanceFeedbackView,
	},
	...
	auth.RoleManager: {
		...
		PermissionConsultantView,
		PermissionPerformanceFeedbackView,
		PermissionPerformanceFeedbackEdit,
