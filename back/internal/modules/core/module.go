...
func (m *Module) Permissions() []modules.PermissionDef {
	return []modules.PermissionDef{
		...
		{Key: "workspace.performance_feedback.view", Label: "Ver feedback no Consultor", Description: "Visualizar feedbacks de desempenho dentro da pagina Consultor.", Scope: "account"},
		{Key: "workspace.performance_feedback.edit", Label: "Conduzir feedback", Description: "Registrar feedback e plano de acao dos consultores.", Scope: "account"},
		...
		{Key: "workspace.transcricoes.view", Label: "Ver pagina Transcricoes", Description: "Visibilidade de audios e transcricoes dos atendimentos.", Scope: "account"},
		{Key: "workspace.transcricoes.edit", Label: "Gerenciar Transcricoes", Description: "Solicitar transcricoes, analises e editar sua configuracao.", Scope: "account"},
		...
		{Key: "workspace.planejamento.view", Label: "Ver pagina Planejamento", Description: "Visualizar escalas, jornadas e metas do Planejamento.", Scope: "account"},
		{Key: "workspace.planejamento.edit", Label: "Editar Planejamento", Description: "Editar configuracoes e escalas do Planejamento.", Scope: "account"},
