...
func TestResolveCRMOrderStoreKey(t *testing.T) {
	...
	if got := resolveCRMOrderStoreKey("53578278000107", "12583959000186", "16", employeeStoreFallbacks, employeeDominantStoreKeys); got != "53578278000107" {
		t.Fatalf("expected explicit store key to win over management multi-store for employee 16, got %q", got)
	}
