...
> U4a (2026-06-05): a verificacao de acesso ao tenant (`CanAccessTenant`) e o
> `ResolveDefaultTenantID` agora resolvem membership por `core.account_users`
> (unificado), nao mais por `user_tenant_roles`/`user_store_roles`. Ver
> `docs/USER_MODEL_UNIFICATION_PLAN.md` e `docs/LEGADO.md` item 1.
