...
- `web/app/components/operation/OperationWorkspace.vue`: composicao principal da pagina.
- `web/app/components/operation/OperationScopeBar.vue`: barra unica que concentra aviso de campanha e filtro local da visao integrada.
- `web/app/components/operation/OperationQueueColumns.vue`: coluna da fila e coluna de atendimentos em andamento.
- `web/app/components/operation/OperationActiveServiceCard.vue`: card reutilizavel de atendimento ativo.
- `web/app/components/operation/OperationConsultantStrip.vue`: barra inferior com todos os consultores.
- `web/app/components/operation/OperationFinishModal.vue`: modal de encerramento do atendimento.
- `web/app/components/operation/OperationProductPicker.vue`: seletor reutilizado para produtos vistos e produtos fechados.
