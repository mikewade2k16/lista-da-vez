  ...
  <section class="admin-panel" data-testid="data-panel">
    <header class="admin-panel__header">
      ...
      <p class="admin-panel__text">
        {{
          integratedScope
            ? 'Painel consolidado de produto, motivo, origem, horario e tempo das lojas do tenant ativo.'
            : 'Painel bruto de produto, motivo, origem, horario e tempo.'
        }}
      </p>
    </header>
    ...
    <article v-else-if="pending && !report" class="insight-card">
      <p class="settings-card__text">
        {{
          integratedScope
            ? 'Carregando dados operacionais consolidados...'
            : 'Carregando dados operacionais da loja ativa...'
        }}
      </p>
    </article>
