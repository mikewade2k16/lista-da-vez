...
<template>
  <div
    ...
    :style="{ background: getColorGradient(primaryAlert.colorTheme || 'amber') }"
  >
    <div class="fullscreen-alert__container">
      <div class="fullscreen-alert__header">
        <h1 class="fullscreen-alert__title">
          ⚠️ {{ renderTemplate(primaryAlert.titleTemplate || '', primaryAlert) }}
        </h1>
      </div>

      <div class="fullscreen-alert__content">
        <p class="fullscreen-alert__body">
