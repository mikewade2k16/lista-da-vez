...
export const ROADMAP_PHASES: RoadmapPhase[] = [
  ...
  },
  {
    ...
    tasks: [
      ...
      { id: "card-f2-d-aparencia", label: "WS-D — Aparência/theming curado (site público): editor no painel (tema base + acento + fonte + claro/escuro) -> theme jsonb -> useRestaurantTheme do TAVOLA", done: false },
