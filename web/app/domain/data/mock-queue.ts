...
export const mockQueueState = {
  ...
  customerSourceOptions: (defaultTemplate?.customerSourceOptions || []).map((item) => ({
    ...item,
  })),
  ...
  productCatalog: [
    ...
    {
      id: 'produto-6',
      name: 'Relogio Classico Feminino',
      code: 'REL-CLASS-006',
      category: 'Relogios',
      basePrice: 4200,
    },
