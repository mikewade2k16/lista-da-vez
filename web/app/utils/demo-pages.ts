...
export const DEMO_PAGES = {
  ...
  tasks: {
    ...
    description:
      'Quadro simples de tarefas para acompanhar responsaveis, prioridades e proximas entregas.',
    ...
    rows: [
      {
        title: 'Conferir fila sem responsavel',
        meta: 'Responsavel: Marina',
        status: 'Alta',
        tone: 'warning',
      },
      {
        title: 'Atualizar script de abordagem',
        meta: 'Responsavel: Leo',
        status: 'Em execucao',
        tone: 'info',
      },
      {
        title: 'Fechar retorno de proposta',
        meta: 'Responsavel: Ana',
        status: 'Concluida',
        tone: 'success',
      },
    ],
  ...
  tracking: {
    ...
    eyebrow: 'Jornada',
    description:
      'Linha de acompanhamento para leads, atendimentos e etapas comerciais entre loja e backoffice.',
    ...
    rows: [
      {
        title: 'Cliente chegou na etapa de proposta',
        meta: 'Lead #3912',
        status: 'Proposta',
        tone: 'info',
      },
      {
        title: 'Follow-up excedeu prazo combinado',
        meta: 'Lead #3881',
        status: 'Atrasado',
        tone: 'warning',
      },
      {
        title: 'Venda confirmada pela unidade',
        meta: 'Lead #3850',
        status: 'Convertido',
        tone: 'success',
      },
  ...
  finance: {
    ...
    rows: [
      {
        title: 'Comissao aguardando conferencia',
        meta: 'Loja Centro',
        status: 'Pendente',
        tone: 'warning',
      },
      ...
      {
        title: 'Forecast atualizado pelo gerente',
        meta: 'Meta semanal',
        status: 'Revisado',
        tone: 'info',
      },
  ...
  monitoramento: {
    ...
    eyebrow: 'Operacao',
    description:
      'Painel de saude para filas, integracoes, alertas e eventos importantes do ambiente.',
    ...
    rows: [
      {
        title: 'Webhook de operacao respondendo',
        meta: 'Latencia 84ms',
        status: 'OK',
        tone: 'success',
      },
      {
        title: 'Fila com espera acima do normal',
        meta: 'Loja Norte',
        status: 'Atencao',
        tone: 'warning',
      },
      {
        title: 'Snapshot recebido do backend',
        meta: 'Operacao realtime',
        status: 'Sincronizado',
        tone: 'info',
      },
    ],
  ...
  'tools/scripts': {
    ...
    eyebrow: 'Tools',
    description:
      'Biblioteca de scripts comerciais, respostas rapidas e padroes de abordagem por canal.',
    status: '24 scripts',
  ...
  'team/equipe': {
    ...
    rows: [
      {
        title: 'Equipe Centro completa',
        meta: '8 consultores',
        status: 'Coberta',
        tone: 'success',
      },
      {
        title: 'Loja Norte com baixa cobertura',
        meta: '2 consultores',
        status: 'Atencao',
        tone: 'warning',
      },
  ...
  'team/escalas': {
    ...
    rows: [
      {
        title: 'Reforco no sabado a tarde',
        meta: 'Loja Shopping',
        status: 'Pendente',
        tone: 'warning',
      },
  ...
  'site/paginas': {
    ...
    rows: [
      ...
      {
        title: 'Pagina antiga sem analytics',
        meta: '/catalogo-2025',
        status: 'Ajustar',
        tone: 'warning',
      },
  ...
  'manage/auditoria': {
    ...
    eyebrow: 'Manage',
    description:
      'Eventos administrativos importantes para rastrear ajustes, acessos e alteracoes sensiveis.',
    status: 'Log ativo',
    ...
    rows: [
      {
        title: 'Regra de alerta alterada',
        meta: 'Admin da plataforma',
        status: 'Critico',
        tone: 'warning',
      },
      {
        title: 'Usuario convidado',
        meta: 'Gestao de usuarios',
        status: 'Registrado',
        tone: 'info',
      },
  ...
  'manage/integracoes': {
    ...
    rows: [
      {
        title: 'ERP FTP sincronizado',
        meta: 'Ultimo lote processado',
        status: 'OK',
        tone: 'success',
      },
      {
        title: 'Webhook de campanhas',
        meta: 'Retentativas em fila',
        status: 'Acompanhar',
        tone: 'warning',
      },
