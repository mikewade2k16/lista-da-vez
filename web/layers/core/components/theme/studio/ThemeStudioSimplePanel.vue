...
import type {
  FontItem,
  ThemeStudioHeaderState,
  ThemeStudioPageHeaderState,
} from '../../../composables/useThemeStudio'
  ...
  <div class="grid gap-4 xl:grid-cols-5">
    ...
    >
      ...
      <div class="mt-3 space-y-3">
        <USelect
          :model-value="props.fontValue"
          :items="props.fontItems"
          class="w-full"
          @update:model-value="emit('update-font', $event)"
        />

        <h2 class="text-sm font-semibold uppercase tracking-wide text-[rgb(var(--muted))] pt-3">
          Radius
        </h2>
        <div class="mt-3 space-y-3">
          <div
            v-for="key in props.radiusKeys"
            :key="key"
          ...
          >
            ...
            <UInput
              :model-value="String(props.radiusValueMap[key] ?? 0)"
              type="number"
              min="0"
              max="64"
            ...
            />
            <div
              class="h-10 w-10 border border-[rgb(var(--border))] bg-[rgb(var(--surface-2))]"
    ...
    >
      ...
      <div class="mt-3 space-y-3">
        <div
          class="flex items-center justify-between gap-2 rounded-[var(--radius-sm)] border border-[rgb(var(--border))] bg-[rgb(var(--surface-2))] px-3 py-2"
        >
          <p class="text-xs font-medium uppercase tracking-wide text-[rgb(var(--muted))]">
            Eyebrow
          </p>
    ...
    >
      ...
      <div class="mt-3 space-y-3">
        <div class="space-y-2">
          <div class="flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2">
              ...
              <USwitch
                :model-value="props.headerState.linkBackgrounds"
                @update:model-value="emit('toggle-header-backgrounds', toBool($event))"
              />
            </div>
          </div>
          <ThemeColorInput
            :model-value="props.headerValues.brandBg"
            allow-gradient
            @update:model-value="emit('update-header-brand-bg', $event)"
          />
          <ThemeColorInput
            v-if="!props.headerState.linkBackgrounds"
            :model-value="props.headerValues.panelBg"
            allow-gradient
            @update:model-value="emit('update-header-panel-bg', $event)"
          />
        </div>
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2">
              <span class="text-xs text-[rgb(var(--muted))]">Link Brand/Panel</span>
              <USwitch
                :model-value="props.headerState.linkBlurs"
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div class="space-y-1">
              <p class="text-[11px] uppercase tracking-wide text-[rgb(var(--muted))]">
                Brand Blur (px)
              </p>
              <UInput
                :model-value="String(props.headerValues.brandBlur ?? 0)"
                type="number"
                min="0"
                max="120"
            ...
            <div v-if="!props.headerState.linkBlurs" class="space-y-1">
              ...
              <UInput
                :model-value="String(props.headerValues.panelBlur ?? 0)"
                type="number"
                min="0"
                max="120"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2">
              ...
              <USwitch
                :model-value="props.headerState.linkDividers"
                @update:model-value="emit('toggle-header-dividers', toBool($event))"
              />
            </div>
          </div>
          <ThemeColorInput
            :model-value="props.headerValues.border"
            @update:model-value="emit('update-header-border', $event)"
          />
          <ThemeColorInput
            v-if="!props.headerState.linkDividers"
            :model-value="props.headerValues.separator"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2">
              ...
              <USwitch
                :model-value="props.headerState.textFollowTheme"
                @update:model-value="emit('toggle-header-text-follow', toBool($event))"
              />
            </div>
          </div>
          <ThemeColorInput
            v-if="!props.headerState.textFollowTheme"
            :model-value="props.headerValues.text"
        ...
        <div class="space-y-2">
          <div class="flex items-center justify-between gap-2">
            ...
            <div class="flex items-center gap-2">
              ...
              <USwitch
                :model-value="props.headerState.actionFollowPrimary"
          ...
          <div class="flex items-center justify-end gap-2">
            ...
            <USwitch
              :model-value="props.headerState.linkInteractions"
              @update:model-value="emit('toggle-header-interactions', toBool($event))"
            />
          </div>
          <ThemeColorInput
            :model-value="props.headerValues.hover"
            @update:model-value="emit('update-header-hover', $event)"
          />
          <ThemeColorInput
            v-if="!props.headerState.linkInteractions"
            :model-value="props.headerValues.active"
        ...
        <div class="space-y-2">
          ...
          <div class="space-y-1">
            <p class="text-[11px] uppercase tracking-wide text-[rgb(var(--muted))]">
              Box Shadow (header inteiro)
            </p>
            <UInput
              :model-value="props.headerValues.shellShadow"
              placeholder="none ou 0 10px 24px rgba(...)"
          ...
          <div class="grid gap-2 sm:grid-cols-2">
            <div class="space-y-1">
              ...
              <UInput
                :model-value="String(props.headerValues.fadeTopSize ?? 0)"
                type="number"
                min="0"
                max="80"
            ...
            <div class="space-y-1">
              ...
              <UInput
                :model-value="String(props.headerValues.fadeBottomSize ?? 0)"
                type="number"
                min="0"
                max="80"
          ...
          <div class="space-y-1">
            ...
            <ThemeColorInput
              :model-value="props.headerValues.fadeTop"
              allow-gradient
          ...
          <div class="space-y-1">
            ...
            <ThemeColorInput
              :model-value="props.headerValues.fadeBottom"
              allow-gradient
    ...
    >
      ...
      <div class="mt-3 space-y-3">
        <div class="space-y-2">
          ...
          <ThemeColorInput
            :model-value="props.shadowColor"
            @update:model-value="emit('update-shadow-color', $event)"
          />
        </div>
        <div class="space-y-2">
          <p class="text-xs font-medium uppercase tracking-wide text-[rgb(var(--muted))]">
          ...
          <ThemeColorInput
            :model-value="props.shadowGlowColor"
